    ...
    <GameLayout>
      <div className="max-w-lg mx-auto space-y-6 animate-fade-in">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-display text-2xl font-bold">Escolher Avatar</h1>
            <p className="text-muted-foreground text-sm">Selecione seu avatar pixel art</p>
          </div>
        </div>
        ...
        <div className="bg-card border border-border rounded-xl p-6">
          <PixelAvatarCustomizer
            initialAvatarId={character.avatar_id || "warrior-1"}
